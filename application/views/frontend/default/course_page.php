...
<?php if($adder_other_course_details){ ?>
<!-- start of row of more course by intructor name -->
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      ...
      <h5><b>More Courses <?php if(strtolower($adder_other_course_details[0]['first_name'])!="admin"){ echo "by ".ucfirst($adder_other_course_details[0]['first_name'])." ".ucfirst($adder_other_course_details[0]['last_name']); } ?></b></h5>
      <hr class="my-4">
    ...
    <div id="multi-item-example" class="carousel slide carousel-multi-item" data-ride="carousel">
      ...
      <?php if(count($adder_other_course_details)>4){ ?>
     ...
     <!--  <ol class="carousel-indicators">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <?php
        $count=count($adder_other_course_details);
        for ($i=0; $i < $count; $i++) { ?>
         ...
         <?php
          ...
          ?> 
          <div class="col-md-3">
            <a style="color: black !important;" href="<?php echo site_url('home/course/'.slugify($adder_other_course_details[$j]['title']).'/'.$adder_other_course_details[$j]['id']); ?>">
            <div class="card mb-2">
              <img class="card-img-top" src="<?= $adder_other_course_details[$j]['thumbnail_url']; ?>" 
                alt="Card image cap">
              <div class="card-body">
                <p class="card-title" style="font-size: 14px;font-weight: bold;"><?php echo mb_strimwidth($adder_other_course_details[$j]['title'], 0, 15, "..."); ?></p>
                <p style="font-size: 11px;">
                   <?php echo ucfirst($adder_other_course_details[$j]['first_name'])." ".ucfirst($adder_other_course_details[$j]['last_name']); ?>
                </p>

                
                <p class="rating" style="font-size: 11px;">

                      <?php
                      
                      for($a = 1; $a < 6; $a++){ ?>
                      <?php if ($adder_other_course_details[$j]['average_rating']>1){ ?>
                      

                      <?php if ($a <= $adder_other_course_details[$j]['average_rating']){ ?>
                          <i class="fas fa-star filled"></i>
                      <?php } else{ ?>
                          <i class="fas fa-star"></i>
                      <?php } ?>
                  ...
                  <span class="d-inline-block average-rating">
                    <?php echo $adder_other_course_details[$j]['average_rating']; ?> (<?php echo $adder_other_course_details[$j]['total_rating']; ?>)
                  </span>
                ...
                <p style="font-size: 14px;font-weight: bold;">
                  ...
                  <?php
                   ...
                   if($adder_other_course_details[$j]['is_free_course'] == 1)
                   {
                       echo $adder_other_course_details[$j]['current_price'];
                   }

                   else if($adder_other_course_details[$j]['discount_flag'] == 1)
                   {
                       echo currency($adder_other_course_details[$j]['current_price']);
                   }
...
<!-- end of row of more course by intructor name -->
...
<?php if ($course_details['video_url'] != ""):
  ...
  else if($course_details['course_overview_provider'] == "video_upload")
  {
        ...
        <div class="modal-body">
          <div class="course-preview-video-wrap">
            <div class="embed-responsive embed-responsive-16by9">
              ...
              <!-- start of uploaded video div -->

              <?php elseif (strtolower($provider) == 'video_upload'): ?>

                
              <!-- <div  id="uploaded_video_player">
                  <iframe height="500" src="<?php echo $s3_video_url;?>" allowfullscreen allowtransparency allow="autoplay"></iframe>
              </div> -->
              ...
              <!------------- PLYR.IO ------------>
                ...
                <video poster="<?php echo $this->crud_model->get_course_thumbnail_url($course_details['id']);?>" id="player" playsinline controls>
                  <?php if (get_video_extension($course_details['video_url']) == 'mp4'): ?>
                    <source src="<?php echo $s3_video_url; ?>" type="video/mp4">
                    <?php elseif (get_video_extension($course_details['video_url']) == 'webm'): ?>
                      <source src="<?php echo $s3_video_url; ?>" type="video/webm">
                      <?php else: ?>
